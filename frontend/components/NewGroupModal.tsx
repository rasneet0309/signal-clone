  ...
  return (
    <Modal title="New group" onClose={onClose}>
      <input
        ...
        className="w-full border border-panel-border rounded-lg px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-signal-blue/30 mb-4"
      />
        ...
        {contacts.map((c) => (
          <button
            ...
            className={`w-full flex items-center gap-3 px-2 py-2 rounded-lg text-left transition ${
              selected.has(c.username) ? "bg-signal-blue/10" : "hover:bg-panel-hover"
            }`}
          >
